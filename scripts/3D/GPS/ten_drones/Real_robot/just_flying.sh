...
'
  'Control' 'waitForRos; roslaunch mrs_uav_general core.launch config_mpc_tracker:=./custom_configs/mpc_tracker.yaml config_uav_manager:=./custom_configs/uav_manager_uav1.yaml config_odometry:=./custom_configs/odometry.yaml
'
  'AutoStart' 'waitForRos; roslaunch mrs_uav_general automatic_start.launch
'
  'command_sender' 'waitForRos; roslaunch flocking command_sender.launch config_uav_names:=./custom_configs/uav_names.yaml
'
...
'
  'formation' 'waitForRos; roslaunch flocking formation.launch use_3D:=true config_flocking:=./custom_configs/flocking/modified.yaml
'
